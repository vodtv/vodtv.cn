...
VODTV 提供强大的自定义去广告功能，允许管理员编写 JavaScript 代码实现更精准的 M3U8 视频流广告过滤。
...
- VODTV Issues - 提交 Bug 或功能建议
- VODTV Discussions - 讨论去广告规则和最佳实践
