...
VODTV 的 AI 功能提供智能影视推荐和上下文感知对话，基于 OpenAI 兼容的 API，并支持可选的联网搜索功能。
...
**A:** 每个 Tavily 账号每月提供 **1000 次免费 API 调用**。你可以用不同的邮箱注册多个账号，并在 VODTV 中配置所有 Key 以实现自动轮询。
...
**A:** **可以！** 这是 VODTV 的 **Tavily 纯搜索模式**，完全免费。
